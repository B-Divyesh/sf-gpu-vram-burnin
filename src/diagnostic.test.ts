...
describe('casefile exports', () => {
  it('@claim:sample-offline loads a complete bundled sample without a network request', () => {
  ...
  it('@claim:casefile-export exports the stages and result as JSON', () => {
  ...
  it('@claim:html-casefile exports a printable HTML receipt', () => {
